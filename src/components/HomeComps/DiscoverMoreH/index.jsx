                ...
                <Grid item xs={12} md={6}>
                    <Stack spacing={3}>
                        <Typography variant="h6" sx={{
                            fontWeight: 600, backgroundImage: 'linear-gradient(to right, #373FFF, #3ACAF8, white, white)',
                            WebkitBackgroundClip: 'text', color: ' transparent',  backgroundClip: 'text'
                        }}>Discover More</Typography>
                        <Typography variant="h3" sx={{ fontSize: { xs: '2rem', md: '2.5rem', md: '3rem' } }} >Analyze your sales and marketing leads</Typography>
